...
class ModelDataSource: PlaneAnchoringDataSource {
    ...
    @MainActor
    func insert(side: PlayerModel.Side) -> PersistedModel {
        
        let newModel = PersistedModel(side: side)
    ...
    func getModelsMap() -> Dictionary<UUID, PersistedModel>.Values {
